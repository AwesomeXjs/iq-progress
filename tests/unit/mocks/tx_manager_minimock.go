...
//go:generate minimock -i github.com/AwesomeXjs/iq-progress/pkg/dbclient.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_dbClient "github.com/AwesomeXjs/iq-progress/pkg/dbclient"
	"github.com/gojuno/minimock/v3"
)

// TxManagerMock implements mm_dbClient.TxManager
type TxManagerMock struct {
	t          minimock.Tester
	finishOnce sync.Once

	funcReadCommitted          func(ctx context.Context, f mm_dbClient.Handler) (err error)
	funcReadCommittedOrigin    string
	inspectFuncReadCommitted   func(ctx context.Context, f mm_dbClient.Handler)
	afterReadCommittedCounter  uint64
	beforeReadCommittedCounter uint64
	ReadCommittedMock          mTxManagerMockReadCommitted
}

// NewTxManagerMock returns a mock for mm_dbClient.TxManager
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, f mm_dbClient.Handler) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) ExpectFParam2(f mm_dbClient.Handler) *mTxManagerMockReadCommitted {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, f mm_dbClient.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, f mm_dbClient.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, f mm_dbClient.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
...
// ReadCommitted implements mm_dbClient.TxManager
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, f mm_dbClient.Handler) (err error) {
